...
public class PathSetting {
	...
	public static final String ServiceImplTemplate = baseTemplatePath + "ServiceImpl.temp";
	public static final String entityTemplate = baseTemplatePath + "Entity.temp";
	
	public static final String entityDtoTemplate = baseTemplatePath + "EntityDto.temp";
	public static final String entitySearchDtoTemplate = baseTemplatePath + "EntitySearchDto.temp";
