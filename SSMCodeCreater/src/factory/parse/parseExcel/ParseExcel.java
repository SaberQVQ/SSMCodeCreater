			...
			for (int rowNum = 1; rowNum <= xssfSheet.getLastRowNum(); rowNum++) {
				...
				if (xssfRow != null) {
					...
					case 3:
						break;
					case 4:// 结构状态
						entity.setEntitySteate(getInt(getValue(xssfRow.getCell(3))));
						break;
					case 5:// 创建人
					...
					default:
						...
						editTag = getValue(xssfRow.getCell(9));//条件
						if (editTag.equals("9")) {
						...
						editTag = getValue(xssfRow.getCell(11));//默认值
						if (editTag.equals("9")) {
						...
						//备注信息
						field.setComment(getValue(xssfRow.getCell(13)));
			...
			for (int rowNum = 1; rowNum <= hssfSheet.getLastRowNum(); rowNum++) {
				...
				if (hssfRow != null) {
					...
					case 3:
						break;
					case 4:
						entity.setEntitySteate(getInt(getValue(hssfRow.getCell(3))));
						break;
					case 5:
					...
					default:
						...
						field.setComment(getValue(hssfRow.getCell(13)));
